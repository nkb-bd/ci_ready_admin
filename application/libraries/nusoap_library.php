...
$GLOBALS['_transient']['static']['nusoap_library']['globalDebugLevel'] = 9;
/**
 *
 * nusoap_library
 *
...
class nusoap_library
{
    ...
    {
        $this->debugLevel = $GLOBALS['_transient']['static']['nusoap_library']['globalDebugLevel'];
    }
    /**
    ...
    {
        return $GLOBALS['_transient']['static']['nusoap_library']['globalDebugLevel'];
    }
    /**
    ...
    {
        $GLOBALS['_transient']['static']['nusoap_library']['globalDebugLevel'] = $level;
    }
    /**
 ...
 * @access public
 */
class nusoap_fault extends nusoap_library
{
    /**
 ...
 * @access   public
 */
class nusoap_xmlschema extends nusoap_library
{
    // files
    var $schema = '';
    var $xml = '';
 ...
 * @access   public
 */
class soapval extends nusoap_library
{
    /**
 ...
 * @access public
 */
class soap_transport_http extends nusoap_library
{
    var $url = '';
    var $uri = '';
    var $digest_uri = '';
 ...
 * @access   public
 */
class nusoap_server extends nusoap_library
{
    /**
 ...
 * @access public
 */
class wsdl extends nusoap_library
{
 ...
 * @access   public
 */
class nusoap_parser extends nusoap_library
{
    var $xml = '';
    var $xml_encoding = '';
    var $method = '';
 ...
 * @access   public
 */
class nusoap_client extends nusoap_library
{
    var $username = '';                // Username for HTTP authentication
    var $password = '';                // Password for HTTP authentication
    var $authtype = '';                // Type of HTTP authentication
