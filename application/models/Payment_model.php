...
class Payment_model extends CI_Model {
     ...
     */
    function get_all_payment($tbl='',$limit=0, $offset=0, $filters=array(), $sort='id', $dir='ASC',$user_id=0)
    {
        ...
        $sql = "
            SELECT SQL_CALC_FOUND_ROWS first_name,last_name,users.id as u_id,payment_history.created as created,payment_history.id as payment_id,amount,transaction_type,project_id,title,project_slug
            FROM {$tbl}
