...
class Category_model extends CI_Model {
     ...
     */
    function get_all_category($tbl='',$limit=0, $offset=0, $filters=array(), $sort='id', $dir='ASC')
    {
        ...
        $sql = "
            SELECT SQL_CALC_FOUND_ROWS  cat1.sort_order, cat1.price,cat1.id as id,cat1.name,cat1.deleted,cat1.slug,cat1.created,cat1.parent_category,cat2.name as parent_name ,cat2.id as parent_id
            FROM category as cat1
            LEFT OUTER JOIN category as cat2 on cat1.parent_category  = cat2.id 
