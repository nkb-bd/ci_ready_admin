<?php defined('BASEPATH') OR exit('No direct script access allowed');?>
    ...
    <?php if (!empty($image)): ?>
       ...
       <section class="hero-wrap hero-wrap-2" style="background-image: url('<?php echo  base_url() ?><?php echo  $image ?>');" data-stellar-background-ratio="0.5">
   ...
   <?php if (empty($image)): ?>
      ...
      <div class="container ">
        <div class="row no-gutters  align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate pt-5 pt-5 text-center">
