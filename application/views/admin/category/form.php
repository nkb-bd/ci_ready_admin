...
<?php if (isset($page_data['id'])): ?>
    <?php echo form_open_multipart('admin/sliders/edit/'.$page_data['id'], array('role'=>'form','id'=>'form-upload')); ?>
...
<?php endif ?>
<?php if (!isset($page_data['id'])): ?>
    <?php echo form_open_multipart('admin/sliders/add', array('role'=>'form','id'=>'form-upload')); ?>
