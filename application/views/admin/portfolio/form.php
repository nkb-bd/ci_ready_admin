...
<div class="card ">
    <div class="card-body">
                ...
                <div class="form-group">
                    <label for="main_name">Type</label>
                    <input type="text" required="" name="type" value="<?php echo isset($page_data['type']) ? $page_data['type']: '' ?>" class="form-control" >
                </div>

                <div class="form-group">
                    <label for="sub_name">Url </label>
                    <input type="text"  name="url"  value="<?php echo isset($page_data['url']) ? $page_data['url']: '' ?>" class="form-control" id="sub_name">
                </div>
