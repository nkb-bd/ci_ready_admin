    ...
    <table class="table table-striped table-hover-warning">
        <thead>
            ...
            <tr>
                ...
                <td>
                      <a href="<?php echo current_url(); ?>?sort=designation&dir=<?php echo (($dir == 'asc' ) ? 'desc' : 'asc'); ?>&limit=<?php echo $limit; ?>&offset=<?php echo $offset; ?><?php echo $filter; ?>">Designation</a>
                       <?php if ($sort == 'designation') : ?><span class="fa fa-toggle-<?php echo (($dir == 'asc') ? 'up' : 'down'); ?>"></span><?php endif; ?>
                </td>
                <td>
            ...
            <?php if ($total) : ?>
                <?php foreach ($page_data as $data) : ?>
                    <tr>
                        ...
                        <td<?php echo (($sort == 'designation') ? ' class="sorted"' : ''); ?>>
