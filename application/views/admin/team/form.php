...
<?php if (isset($page_data['id'])): ?>
    <?php echo form_open_multipart('', array('role'=>'form','id'=>'form-upload')); ?>
...
<div class="card ">
    <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" required="" name="name" value="<?php echo isset($page_data['name']) ? $page_data['name']: '' ?>" class="form-control" >
                </div>
        
                <div class="form-group">
                    <label for="main_name">Designation</label>
                    <input type="text" required="" name="designation" value="<?php echo isset($page_data['designation']) ? $page_data['designation']: '' ?>" class="form-control" >
                </div>

                <div class="form-group">
                    <label for="sub_name">FB Link </label>
                    <input type="text"  name="fb_link"  value="<?php echo isset($page_data['fb_link']) ? $page_data['fb_link']: '' ?>" class="form-control" id="sub_name">
                </div>
             
                <div class="form-group">
                    <label for="sub_name">Twitter Link </label>
                    <input type="text"  name="twitter_link"  value="<?php echo isset($page_data['twitter_link']) ? $page_data['twitter_link']: '' ?>" class="form-control" id="sub_name">
                </div>
              ...
              $.ajax({
                  ...
                  error:function(XMLHttpRequest, textStatus, errorThrown){
                    console.log(XMLHttpRequest, textStatus, errorThrown);
                       ...
                       var alert = '<div class="alert alert-danger "><button type="button" class="close" data-dismiss="alert" aria-label="Close"><i class="fa fa-times text-white"></i></button>  '+errorThrown+' </div>';
